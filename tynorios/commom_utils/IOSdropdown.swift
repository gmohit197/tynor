...
open class DropDownUtil : UITextField{
       ...
       var arrow : Arrow!
        ...
        func reSizeTable() {
            ...
            UIView.animate(withDuration: 0.2,delay: 0.1,usingSpringWithDamping: 0.9,initialSpringVelocity: 0.1,options: .curveEaseInOut,
                           animations: { () -> Void in
    ...
    extension DropDownUtil: UITableViewDataSource {
...
//            }
    ...
    extension DropDownUtil: UITableViewDelegate {
